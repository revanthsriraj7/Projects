...
### EDIT YOUR PID VALUES HERE ###
    ...
    '''
    pid = PIDController(
        Kp=61.2,    # Increased Proportional gain for better responsiveness
        Ki=10.2,   # Decreased Integral gain to reduce overshoot
        Kd=22.2  # Increased Derivative gain to dampen oscillations
    )
### EDIT YOUR PID VALUES HERE ###
    # Run simulation
